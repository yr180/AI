...
An agent "*" is on the left of a 1D world, the treasure is on the rightmost location.
...
REFRESH_TIME = 0.3    				# fresh time for one move
...
def get_env_feedback(S, A):                     # This is how agent will interact with the environment
    if A == 'right':                            # move right
        if S == N_STATES - 2:                   # terminate since target reached
            S_ = 'terminal'
